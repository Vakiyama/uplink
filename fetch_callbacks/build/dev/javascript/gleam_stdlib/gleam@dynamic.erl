...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 28).
?DOC(
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 44).
?DOC(" Converts any Gleam data into `Dynamic` data.\n").
-spec from(any()) -> dynamic_().
from(A) ->
    gleam_stdlib:identity(A).

-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 47).
-spec dynamic(dynamic_()) -> {ok, dynamic_()} | {error, list(decode_error())}.
dynamic(Value) ->
    {ok, Value}.

-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 52).
-spec bit_array(dynamic_()) -> {ok, bitstring()} | {error, list(decode_error())}.
bit_array(Data) ->
    gleam_stdlib:decode_bit_array(Data).

-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 78).
-spec map_errors(
    {ok, CHR} | {error, list(decode_error())},
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 85).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 66).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 61).
-spec string(dynamic_()) -> {ok, binary()} | {error, list(decode_error())}.
string(Data) ->
    decode_string(Data).

-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 90).
-spec int(dynamic_()) -> {ok, integer()} | {error, list(decode_error())}.
int(Data) ->
    gleam_stdlib:decode_int(Data).

-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 99).
-spec float(dynamic_()) -> {ok, float()} | {error, list(decode_error())}.
float(Data) ->
    gleam_stdlib:decode_float(Data).

-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 108).
-spec bool(dynamic_()) -> {ok, boolean()} | {error, list(decode_error())}.
bool(Data) ->
    gleam_stdlib:decode_bool(Data).

-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 117).
-spec shallow_list(dynamic_()) -> {ok, list(dynamic_())} |
    {error, list(decode_error())}.
shallow_list(Value) ->
    gleam_stdlib:decode_list(Value).

-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 169).
-spec optional(fun((dynamic_()) -> {ok, CJG} | {error, list(decode_error())})) -> fun((dynamic_()) -> {ok,
        gleam@option:option(CJG)} |
    {error, list(decode_error())}).
optional(Decode) ->
    fun(Value) -> gleam_stdlib:decode_option(Value, Decode) end.

-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 235).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 472).
-spec do_any(
    list(fun((dynamic_()) -> {ok, CNK} | {error, list(decode_error())}))
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 307).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 126).
-spec result(
    fun((dynamic_()) -> {ok, CIO} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, CIQ} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {ok, CIO} | {error, CIQ}} |
    {error, list(decode_error())}).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 157).
-spec list(fun((dynamic_()) -> {ok, CJB} | {error, list(decode_error())})) -> fun((dynamic_()) -> {ok,
        list(CJB)} |
    {error, list(decode_error())}).
list(Decoder_type) ->
    fun(Dynamic) ->
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 178).
-spec field(
    any(),
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 192).
-spec optional_field(
    any(),
    fun((dynamic_()) -> {ok, CJU} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, gleam@option:option(CJU)} |
    {error, list(decode_error())}).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 325).
-spec tuple2(
    fun((dynamic_()) -> {ok, CLC} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, CLE} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, {CLC, CLE}} | {error, list(decode_error())}).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 342).
-spec tuple3(
...
) -> fun((dynamic_()) -> {ok, {CLH, CLJ, CLL}} | {error, list(decode_error())}).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 361).
-spec tuple4(
...
) -> fun((dynamic_()) -> {ok, {CLO, CLQ, CLS, CLU}} |
    {error, list(decode_error())}).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 382).
-spec tuple5(
...
) -> fun((dynamic_()) -> {ok, {CLX, CLZ, CMB, CMD, CMF}} |
    {error, list(decode_error())}).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 405).
-spec tuple6(
...
) -> fun((dynamic_()) -> {ok, {CMI, CMK, CMM, CMO, CMQ, CMS}} |
    {error, list(decode_error())}).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 437).
-spec dict(
    fun((dynamic_()) -> {ok, CMV} | {error, list(decode_error())}),
    fun((dynamic_()) -> {ok, CMX} | {error, list(decode_error())})
) -> fun((dynamic_()) -> {ok, gleam@dict:dict(CMV, CMX)} |
    {error, list(decode_error())}).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 468).
-spec any(list(fun((dynamic_()) -> {ok, CNG} | {error, list(decode_error())}))) -> fun((dynamic_()) -> {ok,
        CNG} |
    {error, list(decode_error())}).
any(Decoders) ->
    do_any(Decoders).

-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 707).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 490).
-spec decode1(
    fun((CNO) -> CNP),
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 500).
-spec decode2(
    fun((CNS, CNT) -> CNU),
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 514).
-spec decode3(
    fun((CNY, CNZ, COA) -> COB),
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 530).
-spec decode4(
    fun((COG, COH, COI, COJ) -> COK),
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 554).
-spec decode5(
    fun((COQ, COR, COS, COT, COU) -> COV),
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 580).
-spec decode6(
    fun((CPC, CPD, CPE, CPF, CPG, CPH) -> CPI),
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 609).
-spec decode7(
    fun((CPQ, CPR, CPS, CPT, CPU, CPV, CPW) -> CPX),
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 640).
-spec decode8(
    fun((CQG, CQH, CQI, CQJ, CQK, CQL, CQM, CQN) -> CQO),
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic.gleam", 673).
-spec decode9(
    fun((CQY, CQZ, CRA, CRB, CRC, CRD, CRE, CRF, CRG) -> CRH),
