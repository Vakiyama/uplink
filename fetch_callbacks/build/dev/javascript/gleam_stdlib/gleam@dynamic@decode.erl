...
-opaque decoder(DNQ) :: {decoder,
        fun((gleam@dynamic:dynamic_()) -> {DNQ, list(decode_error())})}.
...
-spec run(gleam@dynamic:dynamic_(), decoder(DNY)) -> {ok, DNY} |
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic/decode.gleam", 470).
?DOC(
...
-spec success(DOZ) -> decoder(DOZ).
success(Data) ->
    {decoder, fun(_) -> {Data, []} end}.

-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic/decode.gleam", 708).
-spec decode_dynamic(gleam@dynamic:dynamic_()) -> {gleam@dynamic:dynamic_(),
    list(decode_error())}.
decode_dynamic(Data) ->
    {Data, []}.

-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic/decode.gleam", 862).
?DOC(
...
-spec map(decoder(DRW), fun((DRW) -> DRY)) -> decoder(DRY).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic/decode.gleam", 871).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic/decode.gleam", 909).
?DOC(
...
-spec then(decoder(DSI), fun((DSI) -> decoder(DSK))) -> decoder(DSK).
then(Decoder, Next) ->
    {decoder,
        fun(Dynamic_data) ->
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic/decode.gleam", 952).
-spec run_decoders(
    gleam@dynamic:dynamic_(),
    {DSS, list(decode_error())},
    list(decoder(DSS))
) -> {DSS, list(decode_error())}.
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic/decode.gleam", 939).
?DOC(
...
-spec one_of(decoder(DSN), list(decoder(DSN))) -> decoder(DSN).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic/decode.gleam", 1035).
?DOC(
...
-spec recursive(fun(() -> decoder(DTD))) -> decoder(DTD).
recursive(Inner) ->
    {decoder,
        fun(Data) ->
            Decoder = Inner(),
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic/decode.gleam", 840).
?DOC(
...
-spec optional(decoder(DRS)) -> decoder(gleam@option:option(DRS)).
optional(Inner) ->
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic/decode.gleam", 476).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic/decode.gleam", 599).
-spec run_dynamic_function(
    gleam@dynamic:dynamic_(),
    binary(),
    fun((gleam@dynamic:dynamic_()) -> {ok, DPT} | {error, DPT})
) -> {DPT, list(decode_error())}.
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic/decode.gleam", 648).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic/decode.gleam", 670).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic/decode.gleam", 723).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic/decode.gleam", 895).
?DOC(
...
-spec collapse_errors(decoder(DSF), binary()) -> decoder(DSF).
...
-spec new_primitive_decoder(
    binary(),
    fun((gleam@dynamic:dynamic_()) -> {ok, DSZ} | {error, DSZ})
) -> decoder(DSZ).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic/decode.gleam", 626).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic/decode.gleam", 621).
-spec decode_string(gleam@dynamic:dynamic_()) -> {binary(),
    list(decode_error())}.
decode_string(Data) ->
    run_dynamic_function(Data, <<"String"/utf8>>, fun dynamic_string/1).

-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic/decode.gleam", 794).
-spec fold_dict(
    {gleam@dict:dict(DRE, DRF), list(decode_error())},
    gleam@dynamic:dynamic_(),
    gleam@dynamic:dynamic_(),
    fun((gleam@dynamic:dynamic_()) -> {DRE, list(decode_error())}),
    fun((gleam@dynamic:dynamic_()) -> {DRF, list(decode_error())})
) -> {gleam@dict:dict(DRE, DRF), list(decode_error())}.
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic/decode.gleam", 774).
?DOC(
...
-spec dict(decoder(DQX), decoder(DQZ)) -> decoder(gleam@dict:dict(DQX, DQZ)).
dict(Key, Value) ->
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic/decode.gleam", 742).
?DOC(
...
-spec list(decoder(DQL)) -> decoder(list(DQL)).
list(Inner) ->
    {decoder,
        fun(Data) ->
...
-spec push_path({DOU, list(decode_error())}, list(any())) -> {DOU,
    list(decode_error())}.
...
-spec index(
    list(DOI),
    list(DOI),
    fun((gleam@dynamic:dynamic_()) -> {DOL, list(decode_error())}),
    gleam@dynamic:dynamic_(),
    fun((gleam@dynamic:dynamic_(), list(DOI)) -> {DOL, list(decode_error())})
) -> {DOL, list(decode_error())}.
...
-spec subfield(list(any()), decoder(DNT), fun((DNT) -> decoder(DNV))) -> decoder(DNV).
...
-spec at(list(any()), decoder(DOF)) -> decoder(DOF).
at(Path, Inner) ->
    {decoder,
        fun(Data) ->
            index(
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic/decode.gleam", 515).
?DOC(
...
-spec field(any(), decoder(DPD), fun((DPD) -> decoder(DPF))) -> decoder(DPF).
field(Field_name, Field_decoder, Next) ->
    subfield([Field_name], Field_decoder, Next).

-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic/decode.gleam", 548).
?DOC(
    " Run a decoder on a field of a `Dynamic` value, decoding the value if it is\n"
...
-spec optional_field(any(), DPJ, decoder(DPJ), fun((DPJ) -> decoder(DPL))) -> decoder(DPL).
...
-file("/Users/louis/src/gleam/stdlib/src/gleam/dynamic/decode.gleam", 589).
?DOC(
    " A decoder that decodes a value that is nested within other values. For\n"
    " example, decoding a value that is within some deeply nested JSON objects.\n"
    "\n"
...
-spec optionally_at(list(any()), DPQ, decoder(DPQ)) -> decoder(DPQ).
